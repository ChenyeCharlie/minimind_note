...
2. [01_核心模型 MiniMind](learning_notes/01_核心模型%20MiniMind（逐行+张量维度）.md)
3. [02_LoRA 适配与合并](learning_notes/02_LoRA%20适配与合并（逐行）.md)
4. [03_数据集与对话模板](learning_notes/03_数据集与对话模板（逐行+labels_mask%20维度）.md)
5. [04_训练基础设施](learning_notes/04_训练基础设施（分布式-检查点-采样器）.md)
6. [05_预训练与全量 SFT 训练循环](learning_notes/05_预训练与全量%20SFT%20训练循环.md)
7. [06_LoRA 微调训练](learning_notes/06_LoRA%20微调训练.md)
8. [07_DPO](learning_notes/07_DPO（偏好对齐）.md)
